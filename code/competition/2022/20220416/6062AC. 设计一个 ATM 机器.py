...
class ATM:
    ...
    def withdraw(self, amount: int) -> List[int]:
        out = [0]*5
        i=4
        cntnew = self.cnt.copy()
        for s,c in zip(SIZE[::-1],self.cnt[::-1]):
            c_ = min(c,amount//s)
            if c_:
                out[i]=c_
                cntnew[i]-=c_
...
if __name__ == '__main__':
    datas = [
        ...
        [["ATM","deposit","withdraw"],[[],[[0,10,0,3,0]],[500]]],
    ]
